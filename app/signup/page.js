...
function SignupForm() {
  ...
  // Where to send the user after they finish signing up.
  // /pricing's CTA passes ?next=/subscribe so post-confirmation lands at checkout.
  const next = searchParams.get('next') || '/';

  // If the user is already logged in (e.g. they hit /signup?next=/subscribe
  // while already authenticated), skip the form and go straight to next.
  useEffect(() => {
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <p className="text-[13px] text-center mb-6" style={{ color: '#8a8275' }}>
            Save searches. Get notified. Find grails.
          </p>
          ...
          {confirmationSent ? (
            ...
            <>
              ...
              <p
                className="text-[11px] leading-relaxed text-center mb-3"
                style={{ color: '#6e675b' }}
              >
                By continuing you agree to our{' '}
                <Link href="/terms" className="font-serif italic" style={{ color: '#8a8275' }}>
                  Terms
                </Link>{' '}
                and{' '}
                <Link href="/privacy" className="font-serif italic" style={{ color: '#8a8275' }}>
                  Privacy
                </Link>
                .
              </p>
